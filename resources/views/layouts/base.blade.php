...
<head>
    ...
    <meta name="Description" content="YUKIHOST: Deploy and manage your applications with ease. />
    <meta name="viewport" content="width=device-width,initial-scale=1" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@yukihostio" />
    <meta name="twitter:title" content="YUKIHOST" />
    <meta name="twitter:description" content="Deploy and manage your applications with ease." />
    <meta name="twitter:image" content="https://cdn.yukiapi.io/assets/yukihost/og-image.png" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://yukiapi.site" />
    <meta property="og:title" content="YUKIHOST" />
    <meta property="og:description" content="Deploy and manage your applications with ease." />
    <meta property="og:site_name" content="YUKIHOST" />
    <meta property="og:image" content="https://cdn.yukiapi.io/assets/yukihost/og-image.png" />
    ...
    @endphp
    <title>{{ $name }}{{ $title ?? 'YUKIHOST' }}</title>
    @env('local')
        <link rel="icon" href="{{ asset('yukihost-logo-dev-transparent.png') }}" type="image/png" />
    @else
        <link rel="icon" href="{{ asset('yukihost-logo.svg') }}" type="image/svg+xml" />
    @endenv
    ...
    @if (config('app.name') == 'YUKIHOST Cloud')
        <script defer data-domain="app.yukiapi.site" src="https://analytics.yukiapi.io/js/plausible.js"></script>
    ...
    <script data-navigate-once>
        ...
        @auth
            ...
            window.Echo = new Echo({
                ...
                key: "{{ config('constants.pusher.app_key') }}" || 'yukihost',
