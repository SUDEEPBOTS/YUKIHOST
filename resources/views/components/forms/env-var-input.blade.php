    ...
    <div class="relative" @success.window="type = '{{ $type }}'" x-data="{
        ...
        <input
            ...
            @if ($modelBinding !== 'null')
                ...
                wire:dirty.class="dark:border-l-warning border-l-yukiapi border-l-4"
            @endif
            ...
            <template x-if="suggestions.length === 0 && currentScope">
                <div class="px-3 py-2 text-sm text-neutral-500 dark:text-neutral-400">
                    ...
                    <a :href="getScopeUrl(currentScope)"
                       class="text-yukiapi dark:text-warning hover:underline text-xs mt-1 inline-block"
                       target="_blank">
                ...
                <template x-for="(suggestion, index) in suggestions" :key="index">
                    <div :id="'suggestion-' + index"
                        ...
                        <template x-if="suggestion.type === 'scope'">
                            <span class="text-xs px-2 py-0.5 bg-yukiapi/10 dark:bg-warning/10 text-yukiapi dark:text-warning rounded">
                                SCOPE
                            </span>
                        </template>
