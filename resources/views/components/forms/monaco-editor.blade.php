<div wire:key="{{ random_int(0, PHP_INT_MAX) }}" class="yukihost-monaco-editor flex-1">
    <div x-ref="monacoRef" x-data="{
        ...
        monacoEditorAddLoaderScriptToHead() {
            ...
            if (!window.__yukihostMonacoLoaderAdding && typeof _amdLoaderGlobal === 'undefined') {
                window.__yukihostMonacoLoaderAdding = true;
                let script = document.createElement('script');
                script.src = `/js/monaco-editor-${this.monacoVersion}/min/vs/loader.js`;
                script.onload = () => {
                    window.__yukihostMonacoLoaderAdding = false;
                };
                script.onerror = () => {
                    window.__yukihostMonacoLoaderAdding = false;
                };
        ...
        <div x-cloak x-init="if (typeof _amdLoaderGlobal == 'undefined' && !window.__yukihostMonacoLoaderAdding) {
            monacoEditorAddLoaderScriptToHead();
        }
        checkTheme();
