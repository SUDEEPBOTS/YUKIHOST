<nav class="flex flex-col flex-1 px-2 bg-white border-r dark:border-coolgray-200 border-neutral-300 dark:bg-base"
    ...
    <div class="flex lg:pt-6 pt-4 pb-4 pl-2">
        <div class="flex flex-col w-full">
            <a href="/" {{ wireNavigate() }} class="flex items-center gap-2 hover:opacity-80 transition-opacity"><img src="https://files.catbox.moe/sspaco.jpg" class="w-8 h-8 rounded-full"><span class="text-2xl font-bold tracking-tight dark:text-white">YUKIHOST</span></a>
            <x-version />
        </div>
        <div>
        ...
        <li class="flex-1 overflow-x-hidden">
            <ul role="list" class="flex flex-col h-full space-y-1.5">
                @if (isSubscribed() || !isCloud())
                    ...
                    <li>
                        <a title="Contact us" class="menu-item" href="mailto:hello@yukiapi.site"
                            target="_blank">
