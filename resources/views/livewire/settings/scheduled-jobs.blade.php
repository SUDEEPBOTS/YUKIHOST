    ...
    <div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'executions' }"
        ...
        <div class="flex flex-row gap-4">
            <div @class([
                ...
                :class="activeTab === 'executions' && 'dark:bg-yukiapi bg-yukiapi text-white'"
            ...
            <div @class([
                ...
                :class="activeTab === 'scheduler-runs' && 'dark:bg-yukiapi bg-yukiapi text-white'"
            ...
            <div @class([
                ...
                :class="activeTab === 'skipped-jobs' && 'dark:bg-yukiapi bg-yukiapi text-white'"
