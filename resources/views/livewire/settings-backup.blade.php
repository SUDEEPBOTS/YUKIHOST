<div>
    ...
    <div class="flex flex-col">
        ...
        <div class="pb-4">Backup configuration for YUKIHOST instance.</div>
        <div>
            @if ($server->isFunctional())
                ...
                @else
                    To configure automatic backup for your YUKIHOST instance, you first need to add a database resource
                    into YUKIHOST.
                    <x-forms.button class="mt-2" wire:click="addYUKIHOSTDatabase">Configure Backup</x-forms.button>
                @endif
            @else
