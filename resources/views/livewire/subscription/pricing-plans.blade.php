<div x-data="{ selected: 'monthly' }" class="w-full">
        ...
        <fieldset
            ...
            <label
                :class="selected === 'monthly' ?
                    'dark:bg-yukiapi-100 bg-warning dark:text-white cursor-pointer rounded-sm px-2.5 py-1' :
            ...
            <label
                ...
                <span :class="selected === 'yearly' ? 'dark:text-white' : ''">Annually <span
                        class="text-xs dark:text-warning text-yukiapi">(save ~20%)</span></span>
            </label>
        </fieldset>
    </div>
    ...
    <div class="max-w-xl mx-auto">
        ...
        <div class="mt-6 pt-6 border-t dark:border-coolgray-400 border-neutral-200 text-sm dark:text-neutral-400">
            <p>You need to bring your own servers from any cloud provider (<a class="underline" href="https://yukiapi.site/hetzner" target="_blank">Hetzner</a>, DigitalOcean, AWS, etc.) or connect any device running a <a class="underline" href="https://yukiapi.site/docs/installation#supported-operating-systems" target="_blank">supported OS</a>.</p>
            <p class="mt-3">Need official support for your self-hosted instance? <a class="underline dark:text-white" href="https://yukiapi.site/docs/contact" target="_blank">Contact Us</a></p>
        </div>
    </div>
</div>
