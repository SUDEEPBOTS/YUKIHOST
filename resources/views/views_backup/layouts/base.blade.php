...
<head>
    ...
    <meta name="Description" content="YUKIHOST: An open-source & self-hostable Heroku / Netlify / Vercel alternative" />
    <meta name="viewport" content="width=device-width,initial-scale=1" />
    ...
    @if (config('app.name') == 'YUKIHOST Cloud')
        <script defer data-domain="app.yukiapi.site" src="https://analytics.coollabs.io/js/plausible.js"></script>
